...
class TofetElatfalAudiosScreen extends StatefulWidget {
  const TofetElatfalAudiosScreen({super.key});

  @override
  State<TofetElatfalAudiosScreen> createState() =>
      _TofetElatfalAudiosScreenState();
}

class _TofetElatfalAudiosScreenState extends State<TofetElatfalAudiosScreen> {
  ...
  Future<void> _fetchAudios() async {
    ...
    QuerySnapshot snapshot = await _firestore.collection('elgazarya').get();
